export const country_arr: string[] = [
  "Afghanistan",
  "Albania",
  "Algeria",
  "American Samoa",
...
s_a[175] =
  "Sindh|Punjab|Khyber Pakhtunkhwa|Balochistan|Azad Jammu and Kashmir|Federally Administered Tribal Areas|Islamabad Capital Territory|North-West Frontier Province";
s_a[176] =
